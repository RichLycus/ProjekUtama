...
import { Package, Download, CheckCircle, AlertCircle, Loader2, RefreshCw, Terminal } from 'lucide-react'
...
export default function DependenciesTab({ toolId, toolName }: DependenciesTabProps) {
