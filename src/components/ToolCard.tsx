...
export default function ToolCard({
  ...
  return (
    <div
      className="glass rounded-2xl p-6 hover:shadow-2xl hover:scale-105 transition-all duration-300 group cursor-pointer"
    ...
    >
      ...
      <div className="mb-4">
        ...
        <p className="text-sm text-secondary line-clamp-2 min-h-[2.5rem]">{tool.description}</p>
      </div>
      ...
      >
        ...
        {tool.status === 'active' ? 'Run Tool' : 'Tool Disabled'}
      </button>

      {/* Footer Info */}
      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-dark-border text-xs text-muted flex justify-between">
