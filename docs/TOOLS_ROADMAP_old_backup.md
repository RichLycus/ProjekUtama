...
**Status:** ✅ PRODUCTION READY - Universal Structure Implemented
...
|----------|---------|--------|----------|
| 1 | Folder Structure (Universal Paths) | ✅ Complete | 100% |
| 1.5 | Frontend Tools Separation | ✅ Complete | 100% |
| 2 | Dual File & ZIP Upload System | ✅ Complete | 100% |
| 3 | Auto-Discovery System | ✅ Complete | 100% |
...
✅ **Universal Paths** - Portable across Docker, Windows, macOS, Linux  
✅ **Auto-Discovery** - No manual registration needed!  
✅ **Full Dependencies** - lucide-react, Tailwind CSS, TypeScript  
✅ **Hot Reload** - Save file = instant update  
✅ **Clean Separation** - Backend & frontend in different roots  
✅ **Slug-based Naming** - Human-readable file names  
✅ **Dual Upload** - Support both dual-file & ZIP upload

---

## 📁 Universal File Structure

### **⚠️ CRITICAL: Universal Paths (Golden Rule)**

**HARUS pakai RELATIVE paths, TIDAK BOLEH hardcode absolute paths!**

```bash
❌ SALAH (Hardcoded):
/app/backend/sample_tools/...
/home/user/chimera-ai/backend/...
C:\Projects\chimera-ai\backend\...

✅ BENAR (Relative):
backend/sample_tools/...
backend/frontend_tools/...
```

### **Current Structure (Universal & Portable)**
...
│
└── src/                           ← Main app code (NO tool files here!)
    ├── lib/
...
1. **Backend Organized by Category:**
   - Easy to find tools by type
   - Natural grouping (devtools, multimedia, office, etc.)
   - Backend files at: `backend/sample_tools/{category}/{slug}/backend/main.py`

2. **Frontend Flat Structure:**
   - Fast auto-discovery (no nested scanning)
   - Clean separation from main app code
   - Frontend files at: `backend/frontend_tools/{slug}/{ComponentName}.tsx`

3. **Universal & Portable:**
   - Works on Docker, Windows, macOS, Linux
   - No hardcoded `/app/` or `C:\` paths
